...
const MAX_ARRAY_LENGTH = 1000001;
...
describe("convertPartsToPercent", () => {
  describe("Errors", () => {
    ...
    it("Invaid values in array - string without number", () =>
      expect(() => convertPartsToPercent(["1.5", 1.5, "67px"])).toThrowError(
        new Error("Invalid input: unexpected data in array.")
      ));
  });
  describe("Calculations", () => {
    it("Array length is 0", () =>
      expect(convertPartsToPercent([])).toEqual(["100.000"]));
    it("Array length is 1", () =>
      expect(convertPartsToPercent([221])).toEqual(["100.000"]));
    it("Persent of 0", () =>
